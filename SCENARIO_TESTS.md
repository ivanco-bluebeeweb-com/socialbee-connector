# Plausible Scenario Tests (PST) — SocialBee Connector
...
- `connect_socialbee`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_socialbee`: validated contract & error handling
- `list_profiles`: validated contract & error handling
- `list_categories`: validated contract & error handling
- `list_posts`: validated contract & error handling
- `create_post`: validated contract & error handling
- `delete_post`: validated contract & error handling
