"""Settings panel for SocialBee Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__socialbee_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=socialbee_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_socialbee"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("SocialBee Settings & Accounts", level=2),
